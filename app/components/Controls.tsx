...
import { CurrentSlideData, Data } from "../data";
...
type Props = {
  ...
  handleTransitionData: React.Dispatch<React.SetStateAction<Data | null>>;
  handleCurrentSlideData: React.Dispatch<SetStateAction<CurrentSlideData>>;
  initData: Data;
};
...
const Controls = ({
  ...
  return (
    <div className="flex items-center gap-3 px-0 py-3 md:px-1 md:py-5">
      ...
      <Progress curIndex={currentSlideData.index} lenght={sliderData.length} />
    </div>
  );
};
